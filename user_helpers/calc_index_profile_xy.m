function [index_profile,dx] = calc_index_profile_xy(fiber,Nx,spatial_window,f)
%CALC_INDEX_PROFILE_XY It calculates the 2D index profile of the fiber.
%
...
profile_function = str2func(sprintf('build_%s_xy',fiber_type)); % function that builds the fiber
switch fiber_type
    case 'step'
