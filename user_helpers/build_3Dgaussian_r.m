function output = build_3Dgaussian_r(MFD, tfwhm, time_window, energy, Nt, r, varargin)
%BUILD_3DGAUSSIAN_R Build a 3D temporally-superGaussian pulse with a 
%radially-symmetric Gaussian spatial profile using the following 
%parameters:
%
...
[frequency_shift, t_center, gaussexpo] = optargs{:};
...
spatial_profile = build_2Dgaussian_r(MFD, r, gaussexpo);

%% Output as a struct
output = struct('field',temporal_profile.fields.*spatial_profile.field,...
                'dt',temporal_profile.dt,'r',r);
