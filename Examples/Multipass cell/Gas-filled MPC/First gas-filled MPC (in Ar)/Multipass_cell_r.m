% This code simulates a Ar-filled multipass cell
%
% Lavenu et al., "Nonlinear pulse compression based on a gas-filled multipass cell," Opt. Lett. 43(10), 2252-2255 (2018)
%
...
sim.photoionization_model = true; % consider ionization in gas
...
num_roundtrip = 34;
MPC_length = 0.28; % m
focal_R = 0.3; % m; radius of curvature of the mirror
focal_length = focal_R/2; % m

plate_z = MPC_length/2 + (1:num_roundtrip*2)*MPC_length;

%% Initial condition
MFD0 = 2*((focal_R^2-(MPC_length-focal_R)^2)*sim.lambda0^2/4/pi^2)^(1/4); % from Eq.(4) in Hanna et al., "Nonlinear temporal compression in multipass cells: theory," J. Opt. Soc. Am. B 34(7), 1340-1347 (2017)
tfwhm = 0.275; % ps
energy = 160e3; % nJ
