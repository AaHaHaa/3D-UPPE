function [last_E,...
          opt_dz] = add_DW_RK4IP(E0,...
                                 F_op,FHATHA_energy_restoration,...
                                 D_op,W_op,loss_op,...
                                 dz,...
                                 L0,...
                                 Kz_correction,...
...
if any(W_op(:))
    apply_W = @(x) Kz_correction.*F_op.Fk(W_op.*F_op.iFk(x,FHATHA_energy_restoration),FHATHA_energy_restoration); % apply waveguide effect in position space
else
